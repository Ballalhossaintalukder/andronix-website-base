      ...
      <div class="w-full max-w-md">
        ...
        <div class="text-center">
          ...
          <XyzTransition appear-visible xyz="fade small">
            <h1 class="mt-3 text-3xl md:text-4xl font-extrabold text-white tracking-tight">Create your account.</h1>
          </XyzTransition>
          <p class="mt-4 text-gray-400 md:text-lg">Join Andronix to get started.</p>
        </div>
        ...
        <p class="text-gray-400 mt-8 text-center text-sm">Already registered?
          <NuxtLink to="/auth/login" class="text-primary-400 hover:text-primary-300 font-bold transition duration-200">Login</NuxtLink>
        </p>
      </div>
    </div>
  </div>
